...
5. 크리테오 관련 확정 운영값은 나스미디어 내부 자료 기준으로 답하고, 운영 중 개별 이슈는 "크리테오 코리아 담당자 확인 필요"로 안내합니다.
...
PENDING_QUERY_TERMS: tuple[str, ...] = ()
CRITEO_PENDING_TERMS: tuple[str, ...] = ()
...
def criteo_route_answer() -> str:
    return "크리테오 경유 운영 중 개별 이슈는 크리테오 코리아 담당자 확인이 필요합니다."
