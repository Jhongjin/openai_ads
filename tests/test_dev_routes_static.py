...
class DevRoutesStaticTests(unittest.TestCase):
    ...
    def test_dev_pages_use_new_command_center_markup(self) -> None:
        ...
        self.assertIn('data-admin-required-link', home)
        self.assertIn('data-admin-href="/dev/creative-upload-draft"', home)
        self.assertIn("updateAdminGatedLinks", home)
        self.assertIn("관리자 로그인 후 소재 접수 메뉴를 사용할 수 있습니다.", home)
