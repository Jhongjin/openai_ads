...
class DevRoutesStaticTests(unittest.TestCase):
    ...
    def test_dev_pages_use_new_command_center_markup(self) -> None:
        ...
        self.assertIn("campaignIntakeCopyText", admin)
        self.assertIn("copyTextToClipboard", admin)
        self.assertIn('data-intake-copy="receipt"', admin)
        self.assertIn('data-intake-copy="campaign"', admin)
        self.assertIn('data-intake-copy="adgroup"', admin)
        self.assertIn('data-intake-copy="ad"', admin)
    ...
    def test_dev_redesign_css_asset_is_available(self) -> None:
        ...
        self.assertIn(".campaign-intake-card", response.text)
        self.assertIn(".campaign-intake-tree", response.text)
        self.assertIn(".intake-copy", response.text)
